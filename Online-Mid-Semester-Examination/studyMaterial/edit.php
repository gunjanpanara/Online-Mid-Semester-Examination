      ...
      <div class="col-md-8 col-md-offset-2">
        ...
        <form id="edit_form" class="form-horizontal" role="form" action="" method="POST">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <input type="password" name="pswd" class="form-control" value="<?php htmlspecialchars_decode($row_fetch_login['pswd'],ENT_QUOTES); ?>" class="form-control" id="passwordText" placeholder="Password [8-12]" required/>
            </div>
          </div>
