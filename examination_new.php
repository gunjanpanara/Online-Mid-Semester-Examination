      ...
      <div class="col-md-8 col-md-offset-2">
        ...
        <div class="form-group" id="checkbox_div">
          <div class="form-control col-md-5">
            <input type="radio" name="answer" value="option_a" <?php if(!empty($_SESSION['qa'][$_SESSION['current_que']]['ans']) && $_SESSION['qa'][$_SESSION['current_que']]['ans'] == 'option_a') { echo 'checked="checked"'; } ?> />  <?php echo $_SESSION['qa'][$_SESSION['current_que']]['option_a']; ?>
          </div>
          <div class="form-control col-md-5">
            <input type="radio" name="answer" value="option_b" <?php if(!empty($_SESSION['qa'][$_SESSION['current_que']]['ans']) && $_SESSION['qa'][$_SESSION['current_que']]['ans'] == 'option_b') { echo 'checked="checked"'; } ?> />  <?php echo $_SESSION['qa'][$_SESSION['current_que']]['option_b']; ?>
          </div>
          <div class="form-control col-md-5"> 
            <input type="radio" name="answer" value="option_c" <?php if(!empty($_SESSION['qa'][$_SESSION['current_que']]['ans']) && $_SESSION['qa'][$_SESSION['current_que']]['ans'] == 'option_c') { echo 'checked="checked"'; } ?> />  <?php echo $_SESSION['qa'][$_SESSION['current_que']]['option_c']; ?>
          </div>
          <div class="form-control col-md-5">
            <input type="radio" name="answer" value="option_d" <?php if(!empty($_SESSION['qa'][$_SESSION['current_que']]['ans']) && $_SESSION['qa'][$_SESSION['current_que']]['ans'] == 'option_d') { echo 'checked="checked"'; } ?> />  <?php echo $_SESSION['qa'][$_SESSION['current_que']]['option_d']; ?>
          </div>
        </div>
        ...
        <div class="col-md-8">
          <?php if($_SESSION['current_que'] != 1){ ?>
            <button type="" id="prev_button" onclick="getPrevQue(); return false;" class="btn btn-primary">Previous</button>
          <?php } ?>
