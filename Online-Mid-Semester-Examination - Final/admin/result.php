...
$res = executeQuery("select result_gpa.id,result_gpa.subject,result_gpa.obtained_marks,result_gpa.attend_que,result_gpa.exam_date,reg_gpa.sem,reg_gpa.branch,reg_gpa.enroll from result_gpa,reg_gpa where result_gpa.user_id=reg_gpa.id");
